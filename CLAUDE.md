...
- **Secrets** — Managed via gopass (age backend) in a separate git repo. Decrypted at runtime via `gopass show -o`.
...
- `_set_common_api_keys` — Load API keys from gopass into env
