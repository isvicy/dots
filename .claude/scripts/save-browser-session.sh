...
echo ""
echo "Quick reference — ask kimi to run this via browser_run_code after you've logged in:"
echo ""
echo "  async (page) => {"
echo "    const context = page.context();"
echo "    await context.storageState({ path: '${STORAGE_STATE}' });"
echo "    return 'done';"
echo "  }"
echo ""
